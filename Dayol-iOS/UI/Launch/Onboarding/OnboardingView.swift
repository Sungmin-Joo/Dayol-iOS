...
class OnboardingView: UIView {
    ...
    func configureOnboard() {
        datas.enumerated().forEach {
            ...
            let contentStackView = OnboardingContentView(image: image, description: description, optionStrings: optionStrings)
...
private extension OnboardingView {
    func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            contentPageScrollView.centerYAnchor.constraint(equalTo: centerYAnchor, constant: -20),
