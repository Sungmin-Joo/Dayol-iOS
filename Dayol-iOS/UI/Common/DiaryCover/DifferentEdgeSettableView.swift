//
//  DifferentEdgeSettable.swift
//  Dayol-iOS
//
//  Created by 박종상 on 2020/12/26.
//
...
class DifferentEdgeSettableView: UIView {
    ...
    private func roundCorners(topLeft: CGFloat = 0, topRight: CGFloat = 0, bottomLeft: CGFloat = 0, bottomRight: CGFloat = 0) {
