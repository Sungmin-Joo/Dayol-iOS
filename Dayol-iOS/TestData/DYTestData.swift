...
class DYTestData {
    ...
    var scheduleModels: [PaperScheduler] = [
        PaperScheduler(id: "S0", diaryId: "D0", start: .now, end: Date.now.day(add: 1), name: "스케줄 1", colorHex: UIColor.dayolRed.hexString, showsWeeklyPaper: true, showsMonthlyPaper: true),
        PaperScheduler(id: "S1", diaryId: "D0", start: Date.now.day(add: 2), end: Date.now.day(add: 20), name: "스케줄 2", colorHex: UIColor.dayolBrown.hexString, showsWeeklyPaper: true, showsMonthlyPaper: true),
    ]
